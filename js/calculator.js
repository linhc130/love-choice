function cal() {
    ...
    var totalPrice = Math.round(price * 260 / 1000 + Shipping * 50)
...
if (Shipping == 0 || (Shipping !== Shipping)) {
        ...
        text += `<p>📣報價如下</br>🔷商品金額：[<span class="Price">${toCurrency(price)}</span> * 0.260 + <span class="Shipping">${toCurrency(Shipping)}</span>(代購件數) * 50]` 
